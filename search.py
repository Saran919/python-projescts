...
students = [
    ...
    {"id": "2017", "name": "Karthik", "age": 27, "current_residence": "Canada", "DOB": "1997-01-15"},
...
<body>
    <div class="container">
        <div class="search-bar">
            <form id="searchForm">
                <input type="text" id="search" class="search-input" placeholder="Search by ID, Name, Age, Residence, or DOB">
    ...
    <script>
        function searchStudent() {
            ...
            if (!isNaN(searchTerm)) {
                ...
                query = `?name=${searchTerm}&current_residence=${searchTerm}&DOB=${searchTerm}`;
            }
